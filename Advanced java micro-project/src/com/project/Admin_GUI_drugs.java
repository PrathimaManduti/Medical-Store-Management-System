...
public class Admin_GUI_drugs implements ActionListener
{
    ...
    int i;
    String url = "jdbc:mysql://localhost:3306/medical_management";
    String uname =  "root";
    String pass = "Prathgouth@1";
    ...
    Admin_GUI_drugs()
    {
        ...
        drugs_p_west.setBackground(new Color(251, 152, 152));
        drugs_p_center.setBackground(new Color(251, 152, 152));
    ...
    public void actionPerformed(ActionEvent ae) 
    {
        ...
        else if(ae.getSource() == sales)
        {
            ...
            else
            {
                ...
                sales_db.getContentPane().setBackground(new Color(251, 152, 152));
